...
class colorassadapter (
    ...
    override fun onBindViewHolder(holder: ViewHolder, @SuppressLint("RecyclerView") position: Int) {
        ...
        if(select==position)
        {
            holder.cv_change.backgroundTintList= ColorStateList.valueOf(activity.resources.getColor(
                R.color.purple_200))
        }
        else
        {
