...
public class CreationAdapter2   extends RecyclerView.Adapter<CreationAdapter.ViewHolder>{
    ...
    public CreationAdapter2(ArrayList<File> listdata, Activity activity, com.chetssholic.removebackgeround.interfaceces.selectectposion selectectposion) {
        this.listdata = listdata;
        this.activity = activity;
        this.selectectposion = selectectposion;
    }
    @Override
    public CreationAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View listItem= layoutInflater.inflate(R.layout.image_row2, parent, false);
        CreationAdapter.ViewHolder viewHolder = new CreationAdapter.ViewHolder(listItem);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(CreationAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
